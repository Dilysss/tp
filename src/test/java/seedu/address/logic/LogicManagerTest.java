...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deletestuCommand = "deletestu 9";
        assertCommandException(deletestuCommand, MESSAGE_INVALID_STUDENT_DISPLAYED_INDEX);
    }

    @Test
    public void execute_validCommand_success() throws Exception {
        String listStuCommand = ListStuCommand.COMMAND_WORD;
        assertCommandSuccess(listStuCommand, ListStuCommand.MESSAGE_SUCCESS, model);
    }
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        // Execute add command
        /*String addStuCommand = AddStuCommand.COMMAND_WORD + NAME_DESC_AMY + TELEGRAM_DESC_AMY + EMAIL_DESC_AMY;
