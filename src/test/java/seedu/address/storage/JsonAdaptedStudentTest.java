...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(INVALID_NAME, VALID_TELEGRAM, VALID_EMAIL, VALID_RESPONSE, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(null, VALID_TELEGRAM, VALID_EMAIL, VALID_RESPONSE, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_invalidTelegram_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, INVALID_TELEGRAM, VALID_EMAIL, VALID_RESPONSE, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_nullTelegram_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, null, VALID_EMAIL, VALID_RESPONSE, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAM, INVALID_EMAIL, VALID_RESPONSE, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAM, null, VALID_RESPONSE, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_invalidResponse_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAM, VALID_EMAIL, INVALID_RESPONSE, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_nullResponse_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAM, VALID_EMAIL, null, VALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_invalidAttendance_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAM, VALID_EMAIL, VALID_RESPONSE, INVALID_ATTENDANCE, VALID_HELPTAG);
    ...
    public void toModelType_nullAttendance_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_TELEGRAM, VALID_EMAIL, VALID_RESPONSE, null, VALID_HELPTAG);
